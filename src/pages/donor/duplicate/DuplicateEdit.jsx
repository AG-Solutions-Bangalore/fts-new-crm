      ...
      const onSubmit = (e) => {
        ...
        const data = {
          ...
          axios
            ...
            .then(() => {
              NotificationManager.success("Donor Updated Successfully");
        ...
        {loader ? (
          ...
          <div className="p-6 space-y-6 border-2 border-gray-300 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
              <p>
                <span className='text-sm font-semibold'>FTS ID:</span> {donor.indicomp_fts_id}
              </p>
              <p>
                <strong  className='text-sm font-semibold'>Donor Name:</strong> {donor.indicomp_full_name}
              </p>
              <p>
                <strong className='text-sm font-semibold'>Type:</strong> {donor.indicomp_type}
              </p>
              <p>
                <strong className='text-sm font-semibold'>Donor Type:</strong> {donor.indicomp_donor_type}
              </p>
              <p>
                <strong className='text-sm font-semibold'>Contact Name:</strong> {donor.indicomp_com_contact_name}
              </p>
              <p>
                <strong className='text-sm font-semibold'>Mobile:</strong> {donor.indicomp_mobile_phone}
              </p>
              <p>
                <strong className='text-sm font-semibold'>Email:</strong> {donor.indicomp_email}
              </p>
            </div>
            ...
            <form onSubmit={onSubmit}>
              ...
              <p className="text-sm text-red-600 mb-4">
                Note: Please select the donor carefully. This action cannot be undone.
              </p>
              <button
                type="submit"
                className="w-full py-2 bg-blue-500 text-white font-bold rounded-lg hover:bg-blue-600 disabled:bg-gray-400"
