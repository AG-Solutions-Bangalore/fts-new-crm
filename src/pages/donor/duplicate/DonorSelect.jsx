      ...
      {loader ? (
        ...
        <table className="table-auto w-full   border-collapse border-2 border-gray-200">
          <thead className="bg-gray-100">
            <tr>
              <th className="border border-gray-300 px-4 py-2 text-left">FTS ID</th>
          ...
          <tbody>
            {donors.map((donor) => (
              <tr key={donor.indicomp_fts_id} className="hover:bg-gray-50">
                <td className="border border-gray-300 px-4 py-2">{donor.indicomp_fts_id}</td>
                <td className="border border-gray-300 px-4 py-2">{donor.indicomp_full_name}</td>
                <td className="border border-gray-300 px-4 py-2">{donor.indicomp_mobile_phone}</td>
