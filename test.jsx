...
import { Button, TextInput, Group, Paper, Notification } from "@mantine/core";
  ...
  const handleDownload = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        link.href = url;
        link.setAttribute('download', `receipts_${fromId}_to_${toId}.pdf`);
          ...
          <h2 className="px-5 text-black text-lg flex flex-row justify-between items-center rounded-xl p-2">
            ...
            <form onSubmit={handleDownload} className="flex items-center gap-4">
              <div className="flex flex-col">
                <label htmlFor="fromId" className="text-sm font-medium text-gray-700">From Receipt ID</label>
                <input
                  id="fromId"
                  type="text"
                  inputMode="numeric"
                  ...
                  required
                  className="mt-1 block w-32 px-3 py-1.5 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                />
              </div>
              <div className="flex flex-col">
                <label htmlFor="toId" className="text-sm font-medium text-gray-700">To Receipt ID</label>
                <input
                  id="toId"
                  type="text"
                  inputMode="numeric"
